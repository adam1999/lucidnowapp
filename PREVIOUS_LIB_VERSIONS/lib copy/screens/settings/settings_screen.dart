...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  // Show the premium purchase flow
  Future<void> _showPremiumPurchase(BuildContext context) async {
    final settings = Provider.of<SettingsProvider>(context, listen: false);
    try {
      ...
      // Show paywall
      final purchased = await PurchasesService.showPaywallIfNeeded(context, settings.currentLanguage);
      
      if (purchased) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(AppTranslations.translate('premiumSuccess', settings.currentLanguage)),
      ...
      debugPrint('Error showing premium purchase: $e');
      ScaffoldMessenger.of(context).showSnackBar(
  ...
  Future<void> _manageSubscription(BuildContext context) async {
    ...
    try {
      if (Platform.isIOS || Platform.isMacOS) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(AppTranslations.translate('manageInAppStore', settings.currentLanguage)),
            action: SnackBarAction(
              label: AppTranslations.translate('openSettings', settings.currentLanguage),
              onPressed: () {
                // On iOS, users manage subscriptions in the App Store settings
                PurchasesService.openAppStoreSettings();
              },
            ),
          ),
        );
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(AppTranslations.translate('manageInPlayStore', settings.currentLanguage)),
            action: SnackBarAction(
              label: AppTranslations.translate('openSettings', settings.currentLanguage),
              onPressed: () {
                // On Android, users manage subscriptions in the Play Store
                PurchasesService.openPlayStoreSettings();
              },
            ),
          ),
        );
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      AppTranslations.translate('subscriptionPlan', settings.currentLanguage),
                    ...
                    // Use FutureBuilder to display different content based on premium status
                    FutureBuilder<bool>(
                      future: _isPremiumActive(),
                      builder: (context, snapshot) {
                        ...
                        if (isPremium) {
                          // Premium Subscription Status (styled container)
                          return Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Container(
                                  ...
                                  children: [
                                    Row(
                                      children: [
                                        ...
                                        Text(
                                          AppTranslations.translate('premiumActive', settings.currentLanguage),
                                    ...
                                    Text(
                                      AppTranslations.translate('allFeaturesUnlocked', settings.currentLanguage),
                                      style: TextStyle(
                                        fontSize: 14,
                                ...
                                child: Container(
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      const SizedBox(width: 12),
                                      Text(
                                        AppTranslations.translate('manageSubscription', settings.currentLanguage),
                                        style: const TextStyle(
                                          fontSize: 16,
                                          color: Colors.grey,
                          ...
                          // Free Plan Option (styled container with upgrade button)
                          return Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Container(
                                  ...
                                  children: [
                                    Row(
                                      children: [
                                        ...
                                        const SizedBox(width: 12),
                                        Text(
                                          AppTranslations.translate('freePlan', settings.currentLanguage),
                                          style: const TextStyle(
                                            fontSize: 18,
                                            color: Colors.white,
                                            fontWeight: FontWeight.w600,
                                    ...
                                    const SizedBox(height: 8),
                                    Text(
                                      AppTranslations.translate('limitedFeaturesAvailable', settings.currentLanguage),
                                      style: TextStyle(
                                        fontSize: 14,
                                        color: Colors.white.withOpacity(0.7),
                                      ),
                              ...
                              // Subscription Information Section - Small version
                              Container(
                                width: double.infinity,
                                decoration: BoxDecoration(
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      children: [
                                        ...
                                        Icon(Icons.autorenew, size: 14, color: Colors.white.withOpacity(0.7)),
                              ...
                              InkWell(
                                onTap: () => _showPremiumPurchase(context),
                                child: Container(
                                  width: double.infinity,
                                  decoration: BoxDecoration(
                                    color: const Color(0xFF5E5DE3).withOpacity(0.1),
                                    borderRadius: BorderRadius.circular(12),
                                    border: Border.all(
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      const SizedBox(width: 12),
                                      Text(
                                        AppTranslations.translate('upgradeToPremium', settings.currentLanguage),
                                        style: const TextStyle(
                                          fontSize: 16,
                                          color: Color(0xFF5E5DE3),
                                          fontWeight: FontWeight.w500,
