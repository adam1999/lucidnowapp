...
class MindfulnessChart extends StatelessWidget {
  final List<TimeSeriesData> rawData;
  final TimeRange selectedRange;
  const MindfulnessChart({Key? key, required this.rawData, required this.selectedRange}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: AspectRatio(
        aspectRatio: 1.8,
        child: CustomPaint(
          painter: MindfulnessChartPainter(filteredData, selectedRange),
        ),
      ),
    );
  }
...
class MindfulnessChartPainter extends CustomPainter {
  final List<TimeSeriesData> data;
  final TimeRange selectedRange;
  MindfulnessChartPainter(this.data, this.selectedRange);
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final TextSpan yLabelMin = const TextSpan(
      text: '0',
  ...
  @override
  bool shouldRepaint(covariant MindfulnessChartPainter oldDelegate) {
